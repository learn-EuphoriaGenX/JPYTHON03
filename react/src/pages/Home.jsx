...
function Home() {
    ...
    return (
        <div class="grid grid-cols-2 sm:grid-cols-3 gap-2 px-10">
            {
                images.map((img, idx) =>
                    <a class="group block relative overflow-hidden rounded-lg" href="#">
                        <img class="w-full size-40 object-cover rounded-lg" src={img} alt="Project" />
                        <div class="absolute bottom-1 end-1 opacity-0 group-hover:opacity-100 transition">
                            <div class="flex items-center gap-x-1 py-1 px-2 bg-layer border border-layer-line text-layer-foreground rounded-lg">
